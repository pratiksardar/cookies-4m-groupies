...
const NETWORK_ADDRESSES: NetworkAddresses = {
  ...
  44787: {
    ...
    STABLE_COIN_STAKING: getEnvVar('STABLE_COIN_STAKING_ADDRESS', '0x5FbDB2315678afecb367f032d93F642f64180aa3'),
  },
  ...
  42220: {
    ...
    STABLE_COIN_STAKING: '', // To be deployed on mainnet
  },
};
...
export const STABLE_COIN_STAKING_ADDRESS = NETWORK_ADDRESSES[DEFAULT_CHAIN_ID].STABLE_COIN_STAKING; 