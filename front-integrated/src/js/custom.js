...
$(document).ready(function () {
    // Carga funciones principales
    imageBG();
    grid();

    // Selecciona el botón y el loader
    const connectButton = document.getElementById("connectButton");
    const loader = document.getElementById("loader");

    // Asegúrate de que existan antes de agregar el evento
    if (connectButton && loader) {
        ...
        connectButton.addEventListener("click", () => {
            ...
            // Simula el tiempo de espera de 3 segundos
            setTimeout(() => {
                // Oculta el loader
        ...
        console.error("Connect Button or Loader not found in the DOM.");
    }
});
